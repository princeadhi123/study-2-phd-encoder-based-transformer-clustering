"""
Publication-Quality 3D PCA Figure
=================================
...
colors = {
    ...
    5: "#00c8c8",   # vivid teal
    6: "#ff69b4",   # vivid hot pink
    7: "#8b4513",   # vivid brown
}
...
sil_score = silhouette_score(X_pca, master["narrative_best_label"].values)
...
def create_figure(camera_eye, title_suffix=""):
    ...
    for cluster_id in sorted(master["narrative_best_label"].unique()):
        sub = master[master["narrative_best_label"] == cluster_id]
    ...
    fig.update_layout(
        title=dict(
            text=f"3D PCA — Narrative Clusters (GMM-AICc + Strategy C + MiniLM-L6-v2){title_suffix}",
...
html_path = BASE / "pca_3d_paper_interactive.html"
fig.write_html(str(html_path), include_plotlyjs="cdn")
print(f"Saved: {html_path}")

png_path = BASE / "pca_3d_paper_figure.png"
